...
\begin{figure}
\rotatebox{-90}{\includegraphics[width=15cm,height=15cm,keepaspectratio]{01.ps}}\\
\caption{1.attēls}
\label{i:example}
\end{figure}
...
\begin{figure}
\rotatebox{-90}{\includegraphics[keepaspectratio]{results2.ps}}\\
\caption{4.attēls}
\label{i:example}
\end{figure}
...
\begin{figure}
\rotatebox{-90}{\includegraphics[keepaspectratio]{results1.ps}}\\
\caption{5.attēls}
\label{i:example}
\end{figure}
